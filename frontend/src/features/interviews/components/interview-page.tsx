                ...
                {session.turns.map((turn, i) => (
                  <div key={i} className="p-4 rounded-2xl bg-card border border-border/60 space-y-3">
                    <div className="flex items-center justify-between text-xs font-semibold text-muted-foreground">
                      ...
                      <span className="text-fuchsia-400">Score: {turn.evaluation.turn_score}%</span>
                    </div>
                    <p className="text-xs text-foreground font-medium">Q: {turn.question}</p>
                    ...
                    <div className="p-3 rounded-xl bg-background border border-border/40 text-[11px] text-muted-foreground">
                      <strong className="text-foreground">AI Feedback:</strong> {turn.evaluation.feedback}
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="space-y-6">
            ...
            {finalReport && (
              <div className="glass-card p-6 rounded-3xl border border-fuchsia-500/30 bg-fuchsia-950/10 space-y-4">
                ...
                <p className="text-xs text-muted-foreground">{finalReport.summary}</p>
              </div>
            )}
          </div>
        </div>
